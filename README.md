...
| `worker-rust` | `rust_fancy` | NFA (Advanced) | Rust `fancy-regex`. Lookaround and backrefs on top of the regex crate. | [![Version](https://img.shields.io/docker/v/sunnev/openregex-worker-rust?sort=date&label=latest)](https://hub.docker.com/r/sunnev/openregex-worker-rust/tags) | ![Pulls](https://img.shields.io/docker/pulls/sunnev/openregex-worker-rust?label=) |
| `worker-dotnet` | `dotnet*_nonbacktracking` | Automata | .NET 7+ NonBacktracking mode. Linear time, no lookaround. | [![Version](https://img.shields.io/docker/v/sunnev/openregex-worker-dotnet?sort=date&label=latest)](https://hub.docker.com/r/sunnev/openregex-worker-dotnet/tags) | ![Pulls](https://img.shields.io/docker/pulls/sunnev/openregex-worker-dotnet?label=) |
| `worker-jvm8` | `java8_standard` | NFA | `java.util.regex` on a real JDK 8. The version most code is pinned to. | [![Version](https://img.shields.io/docker/v/sunnev/openregex-worker-jvm8?sort=date&label=latest)](https://hub.docker.com/r/sunnev/openregex-worker-jvm8/tags) | ![Pulls](https://img.shields.io/docker/pulls/sunnev/openregex-worker-jvm8?label=) |
| `worker-ruby` | `ruby_onigmo` | NFA (Advanced) | Ruby Onigmo. Absence groups, `\K`, Regexp.timeout ReDoS guard. | [![Version](https://img.shields.io/docker/v/sunnev/openregex-worker-ruby?sort=date&label=latest)](https://hub.docker.com/r/sunnev/openregex-worker-ruby/tags) | ![Pulls](https://img.shields.io/docker/pulls/sunnev/openregex-worker-ruby?label=) |
| `worker-perl` | `perl_standard` | NFA (Advanced) | The original `perlre`, the dialect everyone else calls compatible. | [![Version](https://img.shields.io/docker/v/sunnev/openregex-worker-perl?sort=date&label=latest)](https://hub.docker.com/r/sunnev/openregex-worker-perl/tags) | ![Pulls](https://img.shields.io/docker/pulls/sunnev/openregex-worker-perl?label=) |
| `worker-postgres` | `postgres_spencer` | Hybrid DFA/NFA | PostgreSQL Spencer ARE. Leftmost-longest, `~` and `regexp_*`. | [![Version](https://img.shields.io/docker/v/sunnev/openregex-worker-postgres?sort=date&label=latest)](https://hub.docker.com/r/sunnev/openregex-worker-postgres/tags) | ![Pulls](https://img.shields.io/docker/pulls/sunnev/openregex-worker-postgres?label=) |
| `worker-mysql` | `mysql_icu` | NFA (ICU) | MySQL 8 ICU engine. Close proxy for Swift/NSRegularExpression. | [![Version](https://img.shields.io/docker/v/sunnev/openregex-worker-mysql?sort=date&label=latest)](https://hub.docker.com/r/sunnev/openregex-worker-mysql/tags) | ![Pulls](https://img.shields.io/docker/pulls/sunnev/openregex-worker-mysql?label=) |
| `worker-posix` | `gnu_grep_bre / gnu_grep_ere` | NFA (POSIX) | Real GNU grep. Answers why `\+` is a quantifier and `+` is not. | [![Version](https://img.shields.io/docker/v/sunnev/openregex-worker-posix?sort=date&label=latest)](https://hub.docker.com/r/sunnev/openregex-worker-posix/tags) | ![Pulls](https://img.shields.io/docker/pulls/sunnev/openregex-worker-posix?label=) |
| `worker-posix` | `gnu_sed_bre / gnu_sed_ere` | NFA (POSIX) | Real GNU sed, line-oriented, BRE by default and ERE with `-E`. | [![Version](https://img.shields.io/docker/v/sunnev/openregex-worker-posix?sort=date&label=latest)](https://hub.docker.com/r/sunnev/openregex-worker-posix/tags) | ![Pulls](https://img.shields.io/docker/pulls/sunnev/openregex-worker-posix?label=) |
| `worker-posix` | `gnu_awk_ere` | NFA (POSIX) | GNU awk ERE. The only shell tool here that reports capture groups. | [![Version](https://img.shields.io/docker/v/sunnev/openregex-worker-posix?sort=date&label=latest)](https://hub.docker.com/r/sunnev/openregex-worker-posix/tags) | ![Pulls](https://img.shields.io/docker/pulls/sunnev/openregex-worker-posix?label=) |
| `worker-vim` | `vim_standard` | NFA | Vim pattern engine. Magic levels, `\zs`/`\ze`, `\{-}` lazy quantifiers. | [![Version](https://img.shields.io/docker/v/sunnev/openregex-worker-vim?sort=date&label=latest)](https://hub.docker.com/r/sunnev/openregex-worker-vim/tags) | ![Pulls](https://img.shields.io/docker/pulls/sunnev/openregex-worker-vim?label=) |
