...
from worker_vim.engine import execute, vim_version
from worker_vim.registry import WORKER_NAME, build_worker_info, register_engines
...
def main() -> None:
    ...
    version = vim_version()
    print(f"[Worker] Driving Vim {version}.", flush=True)
